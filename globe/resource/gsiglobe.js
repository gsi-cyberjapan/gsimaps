...
//190529		fileExtension : info.url.substr(info.url.length-3,3),
	...
	append : function( info, noFinishMove, isHide ,Confirm_FLAG)
	{
		...
		if ((info.id == "tokyo20201") || (info.id == "tokyo20202") || (info.id == "seika3") || (info.id == "seika3_20210619to0627") || (info.id == "seika3_20210628to0708")){
			if(Confirm_FLAG == null){
				var KARI=this;
    ...
    "・詳細については、<a href='https://www.mext.go.jp/sports/b_menu/sports/mcatetop08/list/detail/1372975_00001.htm'>スポーツ庁ホームページ</a>で確認してください。" + "<br>", 
		...
		if ((info.id == "tokyo20201e") || (info.id == "tokyo20202e") || (info.id == "seika3_e") || (info.id =="seika3_e_20210619to0627") || (info.id == "seika3_e_20210628to0708")){
			if(Confirm_FLAG == null){
				var KARI=this;
