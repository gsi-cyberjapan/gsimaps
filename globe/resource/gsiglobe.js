...
GSI.TEXT.EVAC.KIYAKULINK = '<a href="https://www.gsi.go.jp/bousaichiri/hinanbasho.html" target="blank">「指定緊急避難場所」について</a>　<a href="https://hinanmap.gsi.go.jp/index.html" target="blank">市町村別公開日・更新日一覧</a>';
...
GSI.TEXT.EVAC.CONFIRMITEM1 = '本データは、災害対策基本法第49条の4に基づき市町村長が指定した指定緊急避難場所の情報を各市町村に提供いただき、当該市町村に確認の上、地図上に表示したものです。なお、最新でない場合や未掲載の場合があるため、<span style="font-weight:bold; color:#ff0000;">最新かつ詳細の状況などは必ず当該市町村にご確認ください。</span>';
GSI.TEXT.EVAC.CONFIRMITEM2 = '本データを、ダウンロードや印刷等を行い国土地理院サーバ外で利用される場合は、本データの更新にあわせて最新の情報をご利用ください（参照：<a href="https://hinanmap.gsi.go.jp/index.html" target="blank">市町村別公開日・更新日一覧</a>）。';
...
GSI.TEXT.EVAC.DATAITEM3 = '<a href="https://hinanmap.gsi.go.jp/index.html" target="blank">市町村別公開日・更新日一覧</a>';
