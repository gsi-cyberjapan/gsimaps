  ...
  pointToLayer: function(feature, latlng){
    ...
    if((kind != "") && (z >= 5) && (kind != "100")&& (kind != "50100")
      ...
      && (kind != "7201") && (kind != "7211") && (kind != "7221")){
        ...
        iconname = kind + ".png";
        if (z >= 12){
          iconurl = "https://maps.gsi.go.jp/image/vector/12/" + iconname;
          iconsize = 24;
        }
        else if ((z < 12) && (z >= 9)){
          iconurl = "https://maps.gsi.go.jp/image/vector/9/" + iconname;
          iconsize = 16;
        }
        else if ((z < 9) && (z >= 7)){
          iconurl = "https://maps.gsi.go.jp/image/vector/7/" + iconname;
          iconsize = 16;
        }
        else{
          iconurl = "https://maps.gsi.go.jp/image/vector/5/" + iconname;
          iconsize = 10;
        }
    ...
    if (kind == "2930"){
        ...
        if (z > 18){
          ...
          iconurl = "https://maps.gsi.go.jp/image/vector/15/" + iconname;
          iconsize = 18;
        }
        else if (z == 16){
          iconurl = "https://maps.gsi.go.jp/image/vector/15/" + iconname;
